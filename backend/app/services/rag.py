...
class RAGService:
    ...
    async def _detect_document_type(self, file: UploadFile, title: str) -> DocumentType:
        ...
        if any(
            kw in filename or kw in title_lower or kw in content_str
            for kw in ["facture", "invoice", "paiement"]
        ):
            return DocumentType.INVOICE
        elif any(
            kw in filename or kw in title_lower or kw in content_str
            for kw in ["financ", "bilan", "rapport annuel"]
        ):
            return DocumentType.FINANCIAL_REPORT
        elif any(
            kw in filename or kw in title_lower or kw in content_str
            for kw in ["contrat", "contract", "agreement"]
        ):
            return DocumentType.CONTRACT
        elif any(
            kw in filename or kw in title_lower or kw in content_str
            for kw in ["géotechnique", "geotechnical", "sol"]
        ):
            return DocumentType.GEOTECHNICAL_REPORT
        elif any(
            kw in filename or kw in title_lower or kw in content_str
            for kw in ["technique", "technical", "spec"]
        ):
