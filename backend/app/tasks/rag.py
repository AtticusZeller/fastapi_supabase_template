...
def process_document(self, document_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        processing_stats["extraction_time"] = time.time() - extraction_start
        ...
        if document.document_type == DocumentType.UNKNOWN or document.document_type == DocumentType.GENERIC:
        ...
        processing_stats["chunking_time"] = time.time() - chunking_start
        ...
        processing_stats["metadata_time"] = time.time() - metadata_start
...
def generate_embeddings(self, document_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        for chunk in chunks:
            ...
            random_embedding = list(np.random.randn(settings.EMBEDDING_DIMENSION).astype(float))
        ...
        logger.exception(f"Error generating embeddings for document {document_id}: {str(e)}")
